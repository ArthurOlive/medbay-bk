...
public class AttendantDTO implements Serializable {
    ...
    public AttendantDTO(UserSystem userSystem) {
    ...
    public static UserSystem toUserSystem(AttendantDTO attendantDTO) {
        UserSystem userSystem = new UserSystem();

        userSystem.setAuth(new Auth(attendantDTO.getUsername()));
        userSystem.setProfile(new Profile(attendantDTO.getName(),
                attendantDTO.getBirth(),
                attendantDTO.getDocument(),
                attendantDTO.getGender(),
                attendantDTO.getAddress(),
                attendantDTO.getMedaData()));
        userSystem.setRole(attendantDTO.getRole());
